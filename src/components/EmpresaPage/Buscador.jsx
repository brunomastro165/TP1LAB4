...
export const Buscador = () => {
  ...
  const noticiasFiltradas = noticias.filter(noticia =>
    noticia.contenidoHTML.toLowerCase().includes(busqueda.toLowerCase())
  );
                ...
                <div className='flex justify-center w-full relative my-6'>
                  <div className=' w-3/4'>
                    {noticiasFiltradas
                      ...
                      .map((noticia, i) => {
                        return (
                          <div className=' relative flex items-center border-2 border-blue-400 p-1 cursor-pointer my-2' key={i}
                            onClick={(e) => {
                              e.preventDefault();
                              window.location.href = `/Noticia/${noticia.id}`
                            }}>
                            <img className=' w-40' src={noticia.imagenNoticia} alt="" />
